...
\section{Introduction}\label{sec:introduction}
  ...
  \Cref{sec:self-healing} introduces the concept of self-healing systems, summarizes recent research literature in this area, and discusses self-healing challenges in the cloud environment.
