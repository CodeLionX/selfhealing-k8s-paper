...
\newacronym{pdb}{PDB}{\texttt{PodDisruptionBudget}}
...
\newglossaryentry{priority class}{name={\texttt{PriorityClass}},plural={\texttt{PriorityClasses}},description={}}
\newglossaryentry{pod controller}{name={Pod Controller},description={}}
\newglossaryentry{service}{name={\texttt{Service}},description={}}
%% End: Acronyms
...
\subtitle{Self-Adaptation in Micro-Service Architectures with Kubernetes -- SoSe 2019}
...
\begin{keywords}
Self-Healing \and Microservices \and Cloud Computing \and Kubernetes \and Distribution
\end{keywords}
